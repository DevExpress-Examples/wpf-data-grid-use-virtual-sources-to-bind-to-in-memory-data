...
Namespace InfiniteSourceInMemoryData
    Public NotInheritable Class OutlookDataGenerator
        ...
        Public Shared Function CreateIssue() As IssueData
            Return New IssueData(subject:= GetSubject(), user:= GetFrom(), created:= Date.Today.AddDays(-rnd.Next(30)), votes:= rnd.Next(100), priority:= OutlookDataGenerator.GetPriority())
        End Function
    End Class
End Namespace
