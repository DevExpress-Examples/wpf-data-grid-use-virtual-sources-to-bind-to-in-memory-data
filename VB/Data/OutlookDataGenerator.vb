...
Namespace InfiniteSourceInMemoryData
	Public Module OutlookDataGenerator
		...
		Public Function CreateIssue() As IssueData
			Return New IssueData(subject:= GetSubject(), user:= GetFrom(), created:= DateTime.Today.AddDays(-rnd.Next(30)), votes:= rnd.Next(100), priority:= OutlookDataGenerator.GetPriority())
		End Function
	End Module
End Namespace
