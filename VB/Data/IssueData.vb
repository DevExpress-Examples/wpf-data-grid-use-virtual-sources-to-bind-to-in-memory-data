...
Namespace InfiniteSourceInMemoryData
    ...
    Public Class IssueData
        ...
        Public Sub New(ByVal subject As String, ByVal user As String, ByVal created As System.DateTime, ByVal votes As Integer, ByVal priority As InfiniteSourceInMemoryData.Priority)
            Me.Subject = subject
            Me.User = user
            Me.Created = created
            Me.Votes = votes
